"""
Django settings for atriu_43332 project.
...
WSGI_APPLICATION = 'atriu_43332.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "atriu_43332 API",
    "DESCRIPTION": "API documentation for atriu_43332 App",
    "VERSION": "v1",
}
