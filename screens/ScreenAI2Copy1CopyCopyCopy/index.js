...
const WelcomeScreen = () => {
  ...
  return <SafeAreaView style={styles.container}>
      ...
      <View style={styles.FOmJhcJU}></View><View style={styles.MNAXvICC}></View><ImageBackground style={styles.IrVOcqCn} source={{
      ...
      }} resizeMode="cover"></ImageBackground><View style={styles.oNxOAgqq}><Pressable onPress={() => {
          navigation.navigate("ScreenAI2Copy1");
        }}><Text style={styles.fzzyutln}>{"Cohab'em"}</Text></Pressable></View><Text style={styles.CDuNznbY}>Lorem ipsum…</Text><Text style={styles.ZDvOrVcy}>Lorem ipsum…</Text><Text style={styles.dcCRnlCo}>{"Affinity"}</Text><Text style={styles.vFtpsISz}>{"Salient"}</Text><Text style={styles.ogQCdjvP}>{"Biography"}</Text><Text style={styles.BMSBCwZZ}>{"0"}</Text><Text style={styles.iKemfUTY}>{"0"}</Text></View>
      
    <View></View><View></View><View></View><View></View><View style={styles.pcZqJmxb}></View><View></View><View style={styles.RueOYfmX}></View><Text style={styles.Usavnfxt}>{"Atriu.net Copyright 2023"}</Text><View><TouchableOpacity></TouchableOpacity></View><View><TouchableOpacity></TouchableOpacity></View></SafeAreaView>;
};
